...
#include "velocity_smoother_ext/velocity_smoother_ext.hpp"
...
class VelocitySmootherExt : public velocity_smoother_ext::VelocitySmootherExt
{
public:
  VelocitySmootherExt()
  : VelocitySmootherExt() {}
...
TEST(VelocitySmootherExtTest, openLoopTestTimer)
{
  auto smoother =
    std::make_shared<VelocitySmootherExt>();
...
TEST(VelocitySmootherExtTest, approxClosedLoopTestTimer)
{
  auto smoother =
    std::make_shared<VelocitySmootherExt>();
...
TEST(VelocitySmootherExtTest, testfindEtaConstraint)
{
  auto smoother =
    std::make_shared<VelocitySmootherExt>();
  rclcpp_lifecycle::State state;
...
TEST(VelocitySmootherExtTest, testapplyConstraints)
{
  auto smoother =
    std::make_shared<VelocitySmootherExt>();
  rclcpp_lifecycle::State state;
...
TEST(VelocitySmootherExtTest, testapplyConstraintsPositiveToPositiveAccel)
{
  auto smoother =
    std::make_shared<VelocitySmootherExt>();
  rclcpp_lifecycle::State state;
...
TEST(VelocitySmootherExtTest, testapplyConstraintsZeroToPositiveAccel)
{
  auto smoother =
    std::make_shared<VelocitySmootherExt>();
  rclcpp_lifecycle::State state;
...
TEST(VelocitySmootherExtTest, testapplyConstraintsNegativeToPositiveDecelAccel)
{
  auto smoother =
    std::make_shared<VelocitySmootherExt>();
  rclcpp_lifecycle::State state;
...
TEST(VelocitySmootherExtTest, testapplyConstraintsNegativeToNegativeAccel)
{
  auto smoother =
    std::make_shared<VelocitySmootherExt>();
  rclcpp_lifecycle::State state;
...
TEST(VelocitySmootherExtTest, testapplyConstraintsZeroToNegativeAccel)
{
  auto smoother =
    std::make_shared<VelocitySmootherExt>();
  rclcpp_lifecycle::State state;
...
TEST(VelocitySmootherExtTest, testapplyConstraintsPositiveToNegativeDecelAccel)
{
  auto smoother =
    std::make_shared<VelocitySmootherExt>();
  rclcpp_lifecycle::State state;
...
TEST(VelocitySmootherExtTest, testapplyConstraintsPositiveToPositiveDecel)
{
  auto smoother =
    std::make_shared<VelocitySmootherExt>();
  rclcpp_lifecycle::State state;
...
TEST(VelocitySmootherExtTest, testapplyConstraintsPositiveToZeroDecel)
{
  auto smoother =
    std::make_shared<VelocitySmootherExt>();
  rclcpp_lifecycle::State state;
...
TEST(VelocitySmootherExtTest, testapplyConstraintsNegativeToNegativeDecel)
{
  auto smoother =
    std::make_shared<VelocitySmootherExt>();
  rclcpp_lifecycle::State state;
...
TEST(VelocitySmootherExtTest, testapplyConstraintsNegativeToZeroDecel)
{
  auto smoother =
    std::make_shared<VelocitySmootherExt>();
  rclcpp_lifecycle::State state;
...
TEST(VelocitySmootherExtTest, testCommandCallback)
{
  auto smoother =
    std::make_shared<VelocitySmootherExt>();
  rclcpp_lifecycle::State state;
...
TEST(VelocitySmootherExtTest, testClosedLoopSub)
{
  auto smoother =
    std::make_shared<VelocitySmootherExt>();
...
TEST(VelocitySmootherExtTest, testInvalidParams)
{
  auto smoother =
    std::make_shared<VelocitySmootherExt>();
...
TEST(VelocitySmootherExtTest, testInvalidParamsAccelDecel)
{
  auto smoother =
    std::make_shared<VelocitySmootherExt>();
...
TEST(VelocitySmootherExtTest, testDynamicParameter)
{
  auto smoother =
    std::make_shared<VelocitySmootherExt>();
  rclcpp_lifecycle::State state;
